...
def integrate(
    ...
    while True:
        ...
        k_2 = h.to_seconds() * dynamics_func(
            t_0 + (1.0 / 4.0) * h, x_0 + (1.0 / 4.0) * k_1
        )
        k_3 = h.to_seconds() * dynamics_func(
            t_0 + (3.0 / 8.0) * h, x_0 + (3.0 / 32.0) * k_1 + (9.0 / 32.0) * k_2
        )
        k_4 = h.to_seconds() * dynamics_func(
            t_0 + (12.0 / 13.0) * h,
            x_0
            + (1932.0 / 2197.0) * k_1
            - (7200.0 / 2197.0) * k_2
        ...
        k_5 = h.to_seconds() * dynamics_func(
            t_0 + (1.0) * h,
            x_0
            + (439.0 / 216.0) * k_1
            - (8.0) * k_2
        ...
        k_6 = h.to_seconds() * dynamics_func(
            t_0 + (1.0 / 2.0) * h,
            x_0
            - (8.0 / 27.0) * k_1
            + (2.0) * k_2
