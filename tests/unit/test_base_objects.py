...
class Test_TimeSpan(unittest.TestCase):
    def test_constructor(self):
        ...
        self.assertTrue(
            B._whole_seconds == 123456789, "Number of whole seconds not equal."
        )
        self.assertTrue(
            B._nano_seconds == 123456789, "Number of nanoseconds not equal."
        )
        self.assertTrue(
            C._whole_seconds == 123456790, "Number of whole seconds not equal."
        )
        self.assertTrue(
            C._nano_seconds == 234567891, "Number of nanoseconds not equal."
        )
        self.assertTrue(D._whole_seconds == -3, "Number of whole seconds not equal.")
        self.assertTrue(
            D._nano_seconds == -100000000, "Number of nanoseconds not equal."
        )
    ...
    def test_add(self):
        ...
        self.assertTrue(
            C + (-A) + (-B) == TimeSpan.zero(), "Failed to add TimeSpans properly."
        )
    ...
    def test_subract(self):
        ...
        self.assertTrue(
            C - A - B == TimeSpan.zero(), "Failed to subtract TimeSpans properly."
        )
