...
from astrolib.propagators import Euler
...
def main():
    ...
    rk4.dynamics_model.force_models.append(earth_gravity)
    rk45 = RK45()
    rk45.dynamics_model.force_models.append(earth_gravity)

    ephem_rk4 = rk4.get_states([initial_state.epoch + i * rk4.step_size for i in range(0, num_steps)], initial_state)
    ephem_rk45 = rk45.get_states(list(ephem_rk4.vector_epochs), initial_state)
